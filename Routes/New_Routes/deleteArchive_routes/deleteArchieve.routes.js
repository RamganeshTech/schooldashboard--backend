...
deleteArchiveRoutes.get("/getall", multiRoleAuth("correspondent", "accountant", "principal"), getAllDeletedItems);

deleteArchiveRoutes.get("/get/:id", multiRoleAuth("correspondent", "accountant", "principal"), getDeletedItemById);
