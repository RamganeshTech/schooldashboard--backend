...
clubRoutes.get('/getall', multiRoleAuth("correspondent", "principal", "teacher", "parent", "administrator", "accountant" , "viceprincipal"), getAllClubs);

// Get single club details
clubRoutes.get('/get/:id', multiRoleAuth("correspondent", "principal", "teacher", "parent", "administrator", "accountant" , "viceprincipal"), getClubById);
...
clubRoutes.post('/create', multiRoleAuth("correspondent", "administrator"), upload.single('thumbnail'),  createClub);

// Update text details only (Name, Description, isActive)
clubRoutes.put('/updatetext/:id',  multiRoleAuth("correspondent", "administrator"), updateClubText);

// Update thumbnail only (Multipart form-data: 'thumbnail' file)
clubRoutes.put('/updatethumbnail/:id', multiRoleAuth("correspondent", "administrator"), upload.single('thumbnail'), updateClubThumbnail);

// Delete Club (and cascades to delete videos)
clubRoutes.delete('/delete/:id',  multiRoleAuth("correspondent", "administrator"), deleteClub);
...
clubRoutes.get('/video/getall', multiRoleAuth("correspondent", "principal", "teacher", "parent", "administrator", "accountant" , "viceprincipal"), getAllClubVideos);

// Get single video details
clubRoutes.get('/video/get/:id',multiRoleAuth("correspondent", "principal", "teacher", "parent", "administrator", "accountant" , "viceprincipal"),  getClubVideoById);
...
clubRoutes.post('/video/upload',multiRoleAuth("correspondent", "administrator"), upload.single('video'),   createClubVideo);

// Update details only (Title, Topic, Level) - No file upload here
clubRoutes.put('/video/updatedetails/:id',  multiRoleAuth("correspondent", "administrator"), updateClubVideoDetails);
